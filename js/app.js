(() => {
    ...
    tippy_esm("#data-tippy-content", {
        content: '<div><a href=""> <h3>caapet Lamm</h3><h2>Author: Sam Smith</h2></a></div>',
        allowHTML: true,
        interactive: true
    });
    tippy_esm("#data-tippy-sofa", {
        content: '<div><a href=""> <h3>Lime Sofa</h3><h2>Author: Tim Cook</h2></a></div>',
        allowHTML: true,
        interactive: true
    });
    tippy_esm("#data-tippy-cashpo", {
        content: '<div><a href=""> <h3>hand Made </h3><h2>Author: Ben Cook</h2></a></div>',
        allowHTML: true,
        interactive: true
    });
    ...
    function initSliders() {
        if (document.querySelector(".newin-swiper")) new core(".newin-swiper", {
        ...
        if (document.querySelector(".people-swiper")) new core(".people-swiper", {
    ...
    window.onscroll = function() {
        ...
        if (prevScrollpos > currentScrollPos) header.style.top = "0"; else {
            header.classList.add("__blur");
